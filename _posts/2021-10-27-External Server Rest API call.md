...
알고보니 script 설정이 deploy dir를 읽도록 변경되어 있었고, 도움을 통해
webapps에 배포하지 않아도 되는 것을 알게 되었습니다. 
```
```
3. jar file
...
그 부분에 맞춰서 배포를 해야 한다는 점을 인지하지 못했었고 도움을 통해 이해하고 해결했습니다.
```
```
...
내부 IP를 사용해야 호출이 가능합니다. 이 부분에 대한 정확한 인지를 하지 못했었고 
도움을 통해 이해하고 해결하였습니다.
이상입니다.
```
